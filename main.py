...
messages = ["you can do it!", "dont get eaten!", "run, forest, run!", "where theres a will, theres a way", "you can beat it!", "outsmart the snake!"]
message = None
...
if dead:
  ...
  print('woah you woncd Snek how did you do it?!' + term.clear_eos)